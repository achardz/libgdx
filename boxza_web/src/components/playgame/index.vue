<template>
  <section class="bg-reward" id="tick-scoll">
    <v-container fluid id="howToPlay">
      <div
        class="columns is-variable is-1-mobile is-0-tablet is-3-desktop is-8-widescreen is-2-fullhd"
      >
        <nuxt-link class="column is-1 title-method-box" to="/how-to-play"
        >
          วิธีเล่น
        </nuxt-link
        >
        <div class="column detail-method">
          <img
            id="imageRegister"
            class="footer-icon"
            ...
            alt="imageRegister"
          >
          <span class="detail-regis-text" @click="openRegisterModal = true"
          >สมัครสมาชิก</span
          >
          <span>ผ่านอีเมลหรือเครือข่ายสังคม</span>
        </div>
        <div class="column is-1 detail-method image-dot">
          <img
            id="imageDotOne"
        ...
        <div class="column detail-method">
          <img
            ...
            alt="imagToUp"
          >
          <span>เติมเงินจำนวนเพียงพอที่จะเปิดกล่อง</span>
        </div>
        <div class="column is-1 detail-method image-dot">
          <img
            id="imageDotTwo"
        ...
        >
          <v-row>
            ...
            <v-col
              cols="1"
              class="text-right"
              style="position: absolute; right: 5.5in;"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
